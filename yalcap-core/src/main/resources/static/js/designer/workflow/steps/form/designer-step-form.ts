...
(function registerFormStepHook(): void {
    const register = (window as any).registerWorkflowStepHook;
    if (typeof register !== 'function') {
        return;
    }

    function resolveHint(assignment: unknown): string {
    ...
    function ensureAssignmentObject(obj: any): void {
    ...
    function ensureAccessObject(obj: any): void {
        if (!obj || typeof obj !== 'object') {
            return;
        }
    ...
    function ensureUiObject(obj: any): void {
        if (!obj || typeof obj !== 'object') {
            return;
        }
