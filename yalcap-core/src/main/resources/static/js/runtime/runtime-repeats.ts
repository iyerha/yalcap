...
(window as any).runtimeRepeats = {
    initialized: true,
    bindAll: bindRepeatsAll
} as RuntimeRepeatsModule;

if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', bindRepeatsAll);
} else {
    bindRepeatsAll();
}

document.addEventListener('htmx:afterSwap', bindRepeatsAll);
